drop TABLE bi_dashboard.st_game_operate_kpi_statistic ON CLUSTER cluster_1shards_2replicas;
...
) ENGINE = ReplicatedMergeTree('/clickhouse/tables/cluster_1shards_2replicas/{layer}-{shard02}/bi_dashboard/st_game_operate_kpi_statistic', '{replica}')
