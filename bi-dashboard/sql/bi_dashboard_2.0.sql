drop TABLE bi_dashboard.st_game_operate_roi_statistic ON CLUSTER cluster_1shards_2replicas;
...
CREATE TABLE bi_dashboard.st_game_operate_roi_statistic ON CLUSTER cluster_1shards_2replicas(
    ...
    '/clickhouse/tables/cluster_1shards_2replicas/{layer}-{shard02}/bi_dashboard/st_game_operate_roi_statistic',
    '{replica}'
...
drop TABLE bi_dashboard.st_game_operate_channel_statistic ON CLUSTER cluster_1shards_2replicas;
...
CREATE TABLE bi_dashboard.st_game_operate_channel_statistic ON CLUSTER cluster_1shards_2replicas(
    ...
    `soucrce_tag` UInt8 COMMENT '数据来源 1是财务  2是业务',
    ...
    '/clickhouse/tables/cluster_1shards_2replicas/{layer}-{shard02}/bi_dashboard/st_game_operate_channel_statistic',
    '{replica}'
) PARTITION BY timeline
ORDER BY
    (agg_dim,
