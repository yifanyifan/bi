...
sshpass -p 'cW6kyivy=4tmD' ssh root@10.0.45.237 "cd /root/Dockerfiles/bi/datamanagement; docker build -t dchub.stnts.com/dt-test/bus/bi-data-management:0.1 .;"
sshpass -p 'cW6kyivy=4tmD' ssh root@10.0.45.237 "cd /root/Dockerfiles/bi/datamanagement; docker push dchub.stnts.com/dt-test/bus/bi-data-management:0.1;"
...
sshpass -p 'cW6kyivy=4tmD' ssh root@10.0.44.34 "cd /root/dockerfiles/bi_biz; kubectl apply -f bi-data-management-biz.yaml --record; kubectl delete pod bi-data-management-7597f85767-khls9 -n biz"
