...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    @ResponseStatus(value= HttpStatus.OK)
    public ResultEntity baseExceptionHandler(HttpServletRequest req, BusinessException e) {
        log.error("Global BaseExceptionHandler", e);
    ...
    @ResponseBody
    @ResponseStatus(value= HttpStatus.OK)
    public ResultEntity baseExceptionHandler(HttpServletRequest req, ExpiredJwtException e) {
        log.error("Global ExpiredJwtException", e);
        String message = e.getMessage();
        return ResultEntity.exception("token过期");
    }
}
