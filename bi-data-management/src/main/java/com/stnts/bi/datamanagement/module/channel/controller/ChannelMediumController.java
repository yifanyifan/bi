...
@Slf4j
@RestController
@RequestMapping("/channelMedium")
@Api(value = "媒介信息API", tags = {"媒介信息"})
public class ChannelMediumController {
    ...
    public ResultEntity<PageEntity<ChannelMedium>> getChannelMediumPageList(@Validated @RequestBody ChannelMediumPageParam channelMediumPageParam, HttpServletRequest request) throws Exception {
    ...
    public ResultEntity<List<DepartmentVO>> listDepartment(HttpServletRequest request) {
        List<DepartmentVO> departmentVOS = channelMediumService.listDepartment(request);
